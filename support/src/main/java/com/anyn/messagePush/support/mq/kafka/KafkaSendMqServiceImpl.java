package com.anyn.messagePush.support.mq.kafka;

import cn.hutool.core.util.StrUtil;
import com.anyn.messagePush.support.MessageQueuePipeline;
...
@Slf4j
@Service
@ConditionalOnProperty(value = "MessagePush.mq.pipeline", havingValue = MessageQueuePipeline.KAFKA)
public class KafkaSendMqServiceImpl implements SendMqService {
    @Autowired
    private KafkaTemplate kafkaTemplate;

    @Value("${MessagePush.business.tagId.key}")
